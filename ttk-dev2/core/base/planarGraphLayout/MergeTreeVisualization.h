...
namespace ttk {
  ...
  protected:
    ...
    double excludeImportantPairsLower_ = 0.0;
    double excludeImportantPairsHigher_ = 0.0;
    double excludeImportantPairsLower2_ = 0.0;
    double excludeImportantPairsHigher2_ = 0.0;
  ...
  public:
    ...
    void setExcludeImportantPairsHigher(double d) {
      excludeImportantPairsHigher_ = d;
    }
    void setExcludeImportantPairsLower(double d) {
      excludeImportantPairsLower_ = d;
    }
    void setExcludeImportantPairsHigher2(double d) {
      excludeImportantPairsHigher2_ = d;
    }
    void setExcludeImportantPairsLower2(double d) {
      excludeImportantPairsLower2_ = d;
    }
      ...
      while(!queueCrossing.empty()) {
        ...
        for(size_t i = 0; i < allBranchOrigins[nodeOrigin].size(); ++i) {
          ...
          bool isSubBranchImportant = tree->isImportantPair<dataType>(
            branchNodeOrigin, importantPairs_, excludeImportantPairsLower_,
        ...
        if(tree->isImportantPair<dataType>(
             nodeOrigin, importantPairs_, excludeImportantPairsLower_,
             excludeImportantPairsHigher_, excludeImportantPairsLower2_,
             excludeImportantPairsHigher2_))
