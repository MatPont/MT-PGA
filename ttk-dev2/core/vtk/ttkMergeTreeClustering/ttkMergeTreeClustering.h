...
private:
  ...
  double EntropicRegularization = 1.0;
  ...
  bool NormalizeMinMaxPair = false;
  ...
  double ExcludeImportantPairsLower = 0.0;
  double ExcludeImportantPairsHigher = 0.0;
  double ExcludeImportantPairsLower2 = 0.0;
  double ExcludeImportantPairsHigher2 = 0.0;
...
public:
  ...
  void SetEntropicRegularization(double lambda) {
    EntropicRegularization = lambda;
    Modified();
    resetDataVisualization();
  }
  vtkGetMacro(EntropicRegularization, double);
  ...
  void SetNormalizeMinMaxPair(bool normalize) {
    NormalizeMinMaxPair = normalize;
    Modified();
    resetDataVisualization();
  }
  vtkGetMacro(NormalizeMinMaxPair, bool);
  ...
  void SetBarycenterMaximumNumberOfPairs(unsigned int maxNoPairs) {
    BarycenterMaximumNumberOfPairs = maxNoPairs;
    Modified();
    resetDataVisualization();
  }
  vtkGetMacro(BarycenterMaximumNumberOfPairs, unsigned int);
  ...
  vtkSetMacro(ExcludeImportantPairsLower, double);
  vtkGetMacro(ExcludeImportantPairsLower, double);

  vtkSetMacro(ExcludeImportantPairsHigher, double);
  vtkGetMacro(ExcludeImportantPairsHigher, double);

  vtkSetMacro(ExcludeImportantPairsLower2, double);
  vtkGetMacro(ExcludeImportantPairsLower2, double);

  vtkSetMacro(ExcludeImportantPairsHigher2, double);
  vtkGetMacro(ExcludeImportantPairsHigher2, double);
