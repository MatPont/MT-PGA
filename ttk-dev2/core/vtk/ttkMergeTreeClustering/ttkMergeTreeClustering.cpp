...
int ttkMergeTreeClustering::runCompute(
  ...
  if(not ComputeBarycenter) {
    ...
    mergeTreeDistance.setEntropicRegularization(EntropicRegularization);
    ...
    mergeTreeDistance.setNormalizeMinMaxPair(NormalizeMinMaxPair);
    ...
    if(NumberOfBarycenters == 1) { // and numInputs2==0){
      ...
      mergeTreeBarycenter.setEntropicRegularization(EntropicRegularization);
      ...
      mergeTreeBarycenter.setNormalizeMinMaxPair(NormalizeMinMaxPair);
      ...
      mergeTreeBarycenter.setBarycenterMaximumNumberOfPairs(
      ...
      mergeTreeClustering.setEntropicRegularization(EntropicRegularization);
      ...
      mergeTreeClustering.setNormalizeMinMaxPair(NormalizeMinMaxPair);
      ...
      mergeTreeClustering.setBarycenterMaximumNumberOfPairs(
        BarycenterMaximumNumberOfPairs);
...
int ttkMergeTreeClustering::runOutput(
  ...
  if(not ComputeBarycenter) {
    ...
    if(OutputTrees) {
      ...
      visuMaker.setExcludeImportantPairsHigher2(ExcludeImportantPairsHigher2);
      visuMaker.setExcludeImportantPairsLower2(ExcludeImportantPairsLower2);
...
#pragma omp parallel for schedule(dynamic) num_threads(this->threadNumber_)
        ...
        for(int i = 0; i < numInputs; ++i) {
          ...
          visuMaker.setExcludeImportantPairsHigher(ExcludeImportantPairsHigher);
          visuMaker.setExcludeImportantPairsLower(ExcludeImportantPairsLower);
          visuMaker.setExcludeImportantPairsHigher2(
            ExcludeImportantPairsHigher2);
          visuMaker.setExcludeImportantPairsLower2(ExcludeImportantPairsLower2);
      ...
      for(unsigned int c = 0; c < NumberOfBarycenters; ++c) {
        ...
        visuMakerBary.setExcludeImportantPairsHigher2(
          ExcludeImportantPairsHigher2);
        visuMakerBary.setExcludeImportantPairsLower2(
          ExcludeImportantPairsLower2);
